...
export default function Home() {
  return <main>
    ...
    <section className="section section--blush"><div className="deadline-panel"><div className="deadline-copy"><p className="eyebrow">THE ROAD TO THE CROWN</p><h2>Meet them. Support them. Vote with purpose.</h2><p className="lede">The contestants are sharing their faith, stories, service platforms, and purpose. Explore their published profiles and cast your official vote beginning Thursday, August 27, 2026, at 6:00 AM ET.</p><div className="hero-actions" style={{ marginTop: 28 }}><Link className="button button--lipstick" href="/contestants">Meet the Contestants</Link><Link className="button button--paper" href="/donor-center">Open Donor Center</Link></div></div><div className="deadline-art"><Image src="/brand/miss-pgws-2027-logo.png" alt="Official Miss Pretty Girls Who Serve 2027 logo" width={1536} height={1536} sizes="(max-width: 1040px) 100vw, 45vw" /></div></div></section>
